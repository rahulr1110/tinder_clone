    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex-grow flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg smm:px-10 border border-gray-200">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="mt-1">
                  <input
                    ...
                    className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shado-sm placeholder-gray-400 focus:outline-none focus:ring-pink-500 focus:border-pink-500 sm:text-sm"
                  />
                </div>
              </div>
              {/* age */}
              ...
              <div>
                ...
                <div className="mt-1">
                  <textarea
                    ...
                    rows={3}
                    value={bio}
                    onChange={(e)=>setBio(e.target.vaue)}
              ...
              <div>
                ...
                <div className="mt-1 flex itmes-center">
                  <button
                  type="button"
