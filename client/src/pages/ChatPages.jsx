...
const ChatPages = () => {
  ...
  if (isLoadingMyMatches) return <LoadingMessageUI />;
        ...
        <div className="flex-grow overflow-y-auto mb-4 bg-white rounded-lg shadow p-4">
          {messages.length === 0 ? (
            <p className="text-center text-gray-500 py-8">
              Start your converstion with {match.name}
            </p>
          ) : (
            messages.map((msg) => (
              <div
...
const MatchNotFound = () => (
  <div className="h-screen flex flex-col item-center justify-center bg-gray-100 bg-opacity-50 bg-dot-pattern">
    <div className="bg-white p-8 rounded-lg shadow-md text-center">
      ...
      <p className="text-gray-600">
        Opps it seemd this match does'nt exist or has been removed
      </p>
      <Link
        to="/"
...
const LoadingMessageUI = () => (
  <div className="h-screen flex flex-col item-center justify-center bg-gray-100 bg-opacity-50">
    <div className="bg-white p-8 rounded-lg shadow-md text-center">
      ...
      <div className="mt-6 flex justify-center space-x-2">
        <div
          ...
          style={{ animateDelay: "0s" }}
        ></div>
        <div
          className="w-3 h-3 bg-pink-500 ronded-full animate-bounce"
