...
const NoMachesFound = () => (
  <div className="flex flex-col items-center justify-center h-full text-center">
    <Heart className="text-pink-500 mb-4 animate" size={48} />
    <h3 className="text-xl font-semibold text-gray-700 mb-2">No Macthes Yet</h3>
    <p className="text-gray-500 max-w-xs">
      Don't worry! Your perfect match is just arounf the corner Keep swiping
    </p>
  </div>
);
